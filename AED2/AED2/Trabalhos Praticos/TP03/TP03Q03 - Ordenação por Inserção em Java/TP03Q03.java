...
class TP03Q03 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < numEntrada; i++) {
            lista.inserirFim(map.get(Integer.valueOf(entrada[i])).getApp_ID());
        }
        lista.insercaoAppId();
        for (int i = 0; i < lista.getN(); i++) {
            Game game = map.get(lista.getGameAtID(i));
...
class Lista {
    ...
    public void inserirInicio(int game) throws Exception {
        if (n >= array.length) {
    ...
    public void inserirFim(int game) throws Exception {
        if (n >= array.length) {
            throw new Exception("Erro!");
        }
        array[n] = game;
    ...
    public void inserir(int game, int pos) throws Exception {
    ...
    public int getGameAtID(int index) {
        return array[index];
    }
